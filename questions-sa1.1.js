const questionsSA11 = [
    ...
    },
    {
        id: 5,
        type: 'long-answer',
        question: "Desenvolupa de manera extensa com es va produir la transició de l'Imperi Romà als regnes germànics a la península Ibèrica. Parla dels principals pobles que hi van intervenir i del procés de formació del regne visigot de Toledo.",
        modelAnswer: "Fases de la transició: Entrada dels pobles: Al segle V, sueus, vàndals i alans creuen els Pirineus i s'estableixen a Hispània, fora del control efectiu de Roma. Intervenció visigoda com a federats: L'Imperi demana ajuda als visigots (pobles federats) per expulsar aquests pobles. Els visigots derroten els vàndals i alans (que marxen al nord d'Àfrica) i acaben controlant gran part del territori. Formació del Regne: Inicialment, la seva capital és Tolosa (a la Gàl·lia). Després de ser derrotats pels francs, es traslladen a la Península i estableixen la capital a Toledo. Unificació i convivència: El regne visigot va ser l'únic estat que va sobreviure a les invasions i va unificar tot el territori peninsular (excepte zones del nord). La societat era una barreja entre la majoria hispanoromana i la minoria dirigent visigoda, que va acabat adoptant el llatí i el cristianisme.",
        feedback: ""
    }
];