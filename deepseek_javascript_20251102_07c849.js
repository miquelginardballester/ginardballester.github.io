...
if (typeof questionsSA11 === 'undefined') {
    document.body.innerHTML = `
        <div class="container" style="text-align: center; padding: 50px;">
            <h1>Error</h1>
            <p>No s'han pogut carregar les preguntes. Assegura't que l'arxiu questions-sa1.1.js es carrega correctament.</p>
        </div>
    `;
    throw new Error('questionsSA11 no està definida.');
}
